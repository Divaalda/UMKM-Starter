...
function initSeedData() {
    ...
    if (!DB.get('initialized') || !DB.get('init_v13')) {
        ...
        DB.set('seminars', [
            { id: 's1', title: 'Building Authentic Brands in a Competitive Market', type: 'Offline', date: '2026-05-16', time: '08:30 - 11:00 WIB', desc: 'Seminar Bisnis Interaktif bersama Dimas Vandityo (Founder Kalis Donuts). Lokasi: Departemen Ekonomika & Bisnis UGM.', linkDaftar: 'https://docs.google.com/forms/d/e/1FAIpQLSc9xUTbtCMUgl9O3Q3YSBnAz3tWGTyB9Ak6YGx6lWNOp-NMAg/closedform', pamflet: 'images/seminar-1.jpg' },
            { id: 's2', title: 'Rahasia UMKM Ramai Tanpa Iklan Mahal', type: 'Online', date: '2026-04-23', time: '10:00 - Selesai', desc: 'Strategi kolaborasi komunitas bersama Nizelia Basasya Bilqis dari Rumah BUMN Malang.', linkDaftar: 'https://docs.google.com/forms/d/e/1FAIpQLSfABPX5EDwDPXqtX-Kcu9DHoRoei5ZFwd04OIP_15m_XsypJA/viewform', pamflet: 'images/seminar-2.jpg' },
            { id: 's3', title: 'Bangkitkan Ide Usaha: Kreasi Dimsum Nusantara', type: 'Offline', date: '2026-05-08', time: '09:00 - Selesai', desc: 'Pelatihan bersama Ika Hindun Dewi Zulaikha di Rumah BUMN Malang.', linkDaftar: 'https://docs.google.com/forms/d/e/1FAIpQLSevZ7AkrmG17yFPpEQ4e8zVDXzx0R-5sP2aYwFD9zu1X6L5-Q/closedform', pamflet: 'images/seminar-3.jpg' },
            { id: 's4', title: 'Pelatihan Anyaman Rotan Berbasis Bahan Alam', type: 'Offline', date: '2026-05-07', time: '09:00 - Selesai', desc: 'Kreasi Nusantara Bangkit bersama Misriwati Agustina di Rumah BUMN Malang.', linkDaftar: 'https://bit.ly/KreasiiNusantaraBangkitPelatihanAnyamanRotanBerbasisBahanAlam', pamflet: 'images/seminar-4.jpg' },
            { id: 's5', title: 'Memahami Pola Keputusan Pembelian Konsumen', type: 'Online', date: '2026-04-27', time: '10:00 - Selesai', desc: 'Pelatihan online via Zoom bersama Rezy Safira dari Rumah BUMN Malang.', linkDaftar: 'https://docs.google.com/forms/d/e/1FAIpQLSc4u8VoEACaOzZi1XDHqVeoz_8QNBOuN3Xjtki_eGPsELbA0g/viewform', pamflet: 'images/seminar-5.jpeg' },
            { id: 's6', title: 'Cara Jualan Laris di Instagram', type: 'Online', date: '2025-05-20', time: '19:00 - 21:00 WIB', desc: 'Pelajari strategi marketing Instagram untuk UMKM' },
            { id: 's7', title: 'Branding Produk UMKM yang Menarik', type: 'Offline', date: '2025-05-28', time: '09:00 - 12:00 WIB', desc: 'Workshop branding dan packaging produk' },
            { id: 's8', title: 'Mengelola Keuangan UMKM', type: 'Online', date: '2025-06-05', time: '14:00 - 16:00 WIB', desc: 'Tips pencatatan keuangan sederhana untuk usaha kecil' },
            { id: 's9', title: 'Fotografi Produk dengan HP', type: 'Online', date: '2025-06-12', time: '10:00 - 12:00 WIB', desc: 'Teknik foto produk profesional hanya dengan smartphone' },
        ]);
        DB.set('guideSteps', [
